...
class GameConstants {
  ...
  static const difficultyInitialToPeakCurve = Cubic(0.23, 1, 0.45, 0.87);

  static const double topBarPlayingOpacity = 1;
  static const double topBarNonPlayingOpacity = 0.2;

  static const double chanceToSpawnHeart = 0.02;
  static const double chanceToSpawnHeartForFirstTime = 1;
  static const int spawnHeartForFirstTimeMaxCount = 3;
  static const double movingHealthPointSpeedMultiplier = 0.9;
  static double movingHealthMinSpeed = 0.1;
  static double movingHealthMaxSpeed = 0.8;
  static const double bgmVolume = 4;
  static const double soundEffectsVolume = 7;
